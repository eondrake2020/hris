        ...
        <div class="content content-full text-center">
            <div class="mb-15">
                <a class="img-link" href="#">
                    <img class="img-avatar img-avatar96 img-avatar-thumb" src="<?php echo asset('public/images/'.$employee->pic) ?>" alt="">
                </a>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div style="margin-top: 30px;">
                                    ...
                                    @endif                                    
                                    <label for="basic_checkbox_2" style="margin-left: 10px;">is Active Employee?</label>
                                </div>
                            </div>
                        </div>
                    </div>
